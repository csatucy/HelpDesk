...
$query_Allid = "SELECT * FROM answers WHERE answerid =".$id;
...
<form action="update.php" method="post" name="FrontPage_Form3" id="FrontPage_Form3" onsubmit="return FrontPage_Form3_Validator(this)">
  <br />
  ...
  <tr class="sidebardk">
    <td width="593" align="center" height="1" valign="top">
      <span class="style15 style16 style17"><em>You can edit your posted answer 
    				   any time. You can view the answers to still pending problems at the<a href="solved_pending.php"> Request &amp; Answer 
        section.</a></em></span> </td>
  </tr>
