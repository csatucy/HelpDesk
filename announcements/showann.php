...
$query = "SELECT * FROM announce where id=$myid";
...
$findme="-------------------------------------------------------------------------------------";
$row["body"] = str_replace($findme,"<br /> <br />",$row["body"]);

?>
<p align="center" class="titlos">
  <span style="font-size: large">Announcement ID:<?php echo $myid; ?> </span><span class="style1" style="font-size: large"></span><span class="style1">-   </span><span class="titlos"><strong><?php echo $row["subject"]; ?><br />
  </strong></span></p>
<table width="99%"  align="left">
  <tr >
    <th width="32%" align="left" valign="top" class="sidebardk" >
      <div align="center"><span class="titlos" style="font-size: medium"><?php echo _("Posted");?>:</span> <?php echo $row["indate"]; ?></div>      
      <div align="center" style="color: #000000"></div></th>
    <th width="39%" align="left" valign="top" class="sidebardk" ><div align="center" style="color: #000000"><span class="titlos" style="font-size: medium"><?php echo _("Author");?>:</span> <span class="style1"><a href="mailto:<?php echo $row["authoremail"]; ?>"><?php echo $row["author"]; ?> </a></span></div></th>
    <th width="29%" align="left" valign="top" class="sidebardk" ><div align="center" style="color: #000000"><span class="titlos" style="font-size: medium"><?php echo _("Updated");?>:</span> <?php echo $row["up-date"]; if ($row["up-date"]=="") {echo "No";} ?></div></th>
  </tr>
  <tr>
    <th colspan="3" align="left" valign="top" class="sidebarlt" ><?php echo $row["body"]; ?></th>
  </tr>
  <tr>
    <th colspan="3" align="left" valign="top" >
	<?php if ($_SESSION['valid_tech'] || $_SESSION['valid_admin']){?>    <table width="34%"  border="0" align="center">
        <tr align="center" >
          <td><form action="edit-announcement.php?typeid=1&amp;myid=<?php echo $myid; ?>" method="post" name="form1" id="form1">
              <input name="edit" type="submit" id="edit" value="<?php echo _("Edit");?>" />
              </form></td>
		      
    <td><form action="do-announcement.php?act=obsolete&amp;id=<?php echo $myid; ?>" method="post" name="form2" id="form2">
            <input name="obsolete" type="submit" id="obsolete2" value="<?php echo _("Make Obsolete");?>" />
             </form></td>
	         
    <td><form action="do-announcement.php?act=delete&amp;id=<?php echo $myid; ?>" method="post" name="form3" id="form3">
              <input name="delete" type="submit" id="deleted" value="<?php echo _("Delete");?>" />
             </form></td>
	      
    <td><form action="javascript:self.close();" method="post" name="form4" id="form4">
              <input name="Cancel" type="submit" id="Cancel" value="<?php echo _("Cancel");?>" />
              </form></td>
        </tr>
    </table>    <?php }?>	     </th>
  </tr>
...
<title>Viewing CS announcements</title>
