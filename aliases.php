...
?> 
      <div align="center"><span class="titlos"><font color="#800000"><b><b><font color="#800000">Email Aliases for CS Department Groups</font></b></b></font></span> </div>
      <p align="center" class="text_header">The following aliases refer to the Computer Science Department      </p>
<center>
                <table width="93%" height="610" border="0" cellpadding="2" cellspacing="5" class="sidebarlt">
                  <tbody>
                    <tr class="sidebardk_noborder_v2">
                      <td colspan="4" align="center" valign="middle" ><span style="font-weight: bold; font-size: 24px">Staff</span></td>
                    </tr>
                    <tr class="textintence">
                      <td width="12%" align="center" valign="middle" bordercolor="#FFFFFF"><div align="right">csall</div></td>
                      <td width="4%" align="center" valign="middle" bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                      <td width="13%" align="center" valign="middle" bordercolor="#FFFFFF"><div align="left">cs.ucy.ac.cy </div></td>
                      <td width="71%" class="text"><div align="left"><strong>-All department members </strong></div></td>
                    </tr>
                    <tr class="textintence">
                      <td bordercolor="#FFFFFF"><div align="right">csfaculty</div></td>
                      <td bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                      <td bordercolor="#FFFFFF"><div align="left">cs.ucy.ac.cy</div></td>
                      <td class="text"><div align="left"><strong>-For faculty members</strong></div></td>
                    </tr>
                    <tr class="textintence">
                      <td bordercolor="#FFFFFF"><div align="right">cscouncil</div></td>
                      <td bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                      <td bordercolor="#FFFFFF"><div align="left"> cs.ucy.ac.cy </div></td>
                      <td class="text"><div align="left"><strong>-For department council members</strong></div></td>
                    </tr>
                    <tr class="textintence">
                      <td bordercolor="#FFFFFF"><div align="right">csvisiting</div></td>
                      <td bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                      <td bordercolor="#FFFFFF"><div align="left"> cs.ucy.ac.cy </div></td>
                      <td class="text"><div align="left"><strong>-For visiting faculty</strong></div></td>
                    </tr>
                    <tr class="textintence">
                      <td bordercolor="#FFFFFF"><div align="right">csresearch</div></td>
                      <td bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                      <td bordercolor="#FFFFFF"><div align="left"> cs.ucy.ac.cy </div></td>
                      <td class="text"><div align="left"><strong>-Research staff</strong></div></td>
                    </tr>
                    <tr class="textintence">
                      <td bordercolor="#FFFFFF"><div align="right">cstspecial</div></td>
                      <td bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                      <td bordercolor="#FFFFFF"><div align="left">cs.ucy.ac.cy</div></td>
                      <td class="text"><div align="left"><strong>-Special scientists and teaching staff</strong></div></td>
                    </tr>
                    <tr class="textintence">
                      <td bordercolor="#FFFFFF"><div align="right">csstaff</div></td>
                      <td bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                      <td bordercolor="#FFFFFF"><div align="left">cs.ucy.ac.cy</div></td>
                      <td class="text"><div align="left"><strong>-For administrative staff</strong></div></td>
                    </tr>
                    <tr class="textintence">
                      <td bordercolor="#FFFFFF"><div align="right">support</div></td>
                      <td bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                      <td bordercolor="#FFFFFF"><div align="left">cs.ucy.ac.cy</div></td>
                      <td class="text"><div align="left"><strong>-Computing support help desk (use in urgent situations or when you cannot get access to the helpdesk web page)</strong></div></td>
                    </tr>
                  </tbody><hr />
                  <tr align="center" valign="middle" bordercolor="#FFFFFF" bgcolor="#660000" >
                    <td height="2" colspan="4" class="sidebardk_noborder_v2" style="font-weight: bold; font-size: 24px">Students</td>
                  </tr>
                  <tr class="textintence">
                    <td align="center" valign="middle" bordercolor="#FFFFFF"> <div align="right">freshmen</div></td>
                    <td align="center" valign="middle" bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                    <td align="center" valign="middle" bordercolor="#FFFFFF"><div align="left">cs.ucy.ac.cy </div></td>
                    <td align="center" valign="middle" class="text"><div align="left">-For first year students</div></td>
                  </tr>
                  <tr class="textintence">
                    <td bordercolor="#FFFFFF"><div align="right">sophomores</div></td>
                    <td bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                    <td bordercolor="#FFFFFF"><div align="left">cs.ucy.ac.cy</div></td>
                    <td class="text"><div align="left">-For second year</div></td>
                  </tr>
                  <tr class="textintence">
                    <td bordercolor="#FFFFFF"><div align="right">juniors</div></td>
                    <td bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                    <td bordercolor="#FFFFFF"><div align="left"> cs.ucy.ac.cy </div></td>
                    <td class="text"><div align="left">-Third year and</div></td>
                  </tr>
                  <tr class="textintence">
                    <td bordercolor="#FFFFFF"><div align="right">seniors</div></td>
                    <td bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                    <td bordercolor="#FFFFFF"><div align="left"> cs.ucy.ac.cy </div></td>
                    <td class="text"><div align="left">-Fourth year and above</div></td>
                  </tr>
                  <tr class="textintence">
                    <td bordercolor="#FFFFFF"><div align="right">undergrad</div></td>
                    <td bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                    <td bordercolor="#FFFFFF"><div align="left"> cs.ucy.ac.cy </div></td>
                    <td class="text"> <div align="left">-All the undergraduate students</div></td>
                  </tr>
                  <tr class="textintence">
                    <td bordercolor="#FFFFFF"><div align="right">csmsc</div></td>
                    <td bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                    <td bordercolor="#FFFFFF"><div align="left">cs.ucy.ac.cy</div></td>
                    <td class="text"><div align="left">-Master students</div></td>
                  </tr>
                  <tr class="textintence">
                    <td bordercolor="#FFFFFF"><div align="right">csphd</div></td>
                    <td bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                    <td bordercolor="#FFFFFF"><div align="left">cs.ucy.ac.cy</div></td>
                    <td class="text"><div align="left">-PhD students</div></td>
                  </tr>
                  <tr class="textintence">
                    <td bordercolor="#FFFFFF"><div align="right">cspg</div></td>
                    <td bordercolor="#FFFFFF"><div align="center"><img width="25" height="28" src="pictures/aliases_clip_image001_0007.gif" alt="" /></div></td>
                    <td bordercolor="#FFFFFF"><div align="left">cs.ucy.ac.cy</div></td>
                    <td class="text"><div align="left">-All graduate students (Master and PhD)</div></td>
                  </tr>
                </table>
</center>
