...
$query_Allid = "select * from jobsanswers where id=$id ORDER BY id DESC";
...
theForm.descr.value=content;
  ...
  {
    alert("Please enter a value for the \"Describtion\" field.");
    theForm.descr.focus();
    return (false);
  }
...
<form action="update_answer_task.php" method="post" name="FrontPage_Form3" id="FrontPage_Form3" onsubmit="return FrontPage_Form3_Validator(this)">
  <br />
  ...
  <tr class="back">
    <td width="593" align="center" height="21">
        <span class="titlos"><b>Edit your answer</b></font></span><b><strong>
  ...
  <tr class="sidebardk">
    <td width="593" align="center" height="1" valign="top">
      <span class="style15 style16 style17"><em>You can edit your posted answer 
    				   any time. </a></em></span> </td>
  </tr>
    ...
    <td><br />
      <table border="0" height="1" width="579" align="center">
		  <tr>
		    ...
		    <font face="Arial" size="2" nowrap="nowrap"><b>Name:</font></td>
			<td width="575" align="right" height="21"><div align="left">
		  ...
		  <tr>
			  <td align="left" height="21" nowrap="nowrap">
				 <font face="Arial" size="2"><b>Email&nbsp;:<b></font>			  </td>
		  ...
		  <tr>
				<td width="575" align="center" height="21" colspan="2">
					   <br />
					   <font face="Arial" size="2"><b>Detailed description of your problem&nbsp;:<b></font></br></br>
	 <textarea cols="50" rows="12" name="descr" tabindex="4"><?php echo $techdescr ?></textarea>      </td>
		  </tr>
		  <tr>
  				  <td width="575" align="center" height="21" colspan="2">
		  				    <input type="submit" value="Save" tabindex="5" />
		  				    &nbsp;&nbsp;
							<input type="reset" value="Cancell" tabindex="5" />
              <br />
              <br />
              <font color="#FF0000" size="1" face="Arial" class="note"> <strong>Note</strong> 
              : You will be<b> notified at the email </b>address you gave above, 
              <b>every time</b> someone follows up or solves your request. </font>            </td>
		  </tr>
		</table>
	</td>
</tr>
 <tr>
    <td width="593" align="center" bgcolor="#FFEEDD" height="21">&nbsp;
