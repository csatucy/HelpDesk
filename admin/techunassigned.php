...
$mySQL3="SELECT * from technicians where techlogin='".$_SESSION['valid_tech']."'";
$rstemp3_query=mysql_query($mySQL3);  
$rstemp3=mysql_fetch_array($rstemp3_query);

$mySQLx="select * from problems ";
$mySQLx=$mySQLx."where assigned=0 AND solvedstate=0 ";
$mySQLx=$mySQLx." ORDER BY problemid ASC";
...
<div align="center"><center>
  <span class="textintence"><br />
  Pool of Unassigned Problems</span> <span class="text">
  (Assign a problem to yourself)
  </span>
  <div align="center">
    <center>
    </center>
...
<p align="center"><font color="#800000" face="Arial"><font color="red"><?php echo $valid_tech; ?></font></font>
...
<table width="100%" border="0">
  <tr>
    <td width="100%"><table border="0" width="100%" align="center" height="100%">
        <tr>
          <td width="8%"  height="100%" class="sidebardk">No</td>
          <td width="7%"  height="100%" class="sidebardk" >State</td>
          <td width="42%"  height="100%" class="sidebardk">Topic</td>
          <td width="16%" height="100%" class="sidebardk" >Originator</td>
          <td width="17%" height="100%" class="sidebardk" >Date</td>
          <td width="10%" height="100%" class="sidebardk" >Assign to myself</td>
        </tr>
...
?>
        <tr align="center" bgcolor="#FFFFCC">
          <td  height="100%" class="sidebarlt" ><small><?php echo $rstempx["problemid"]; ?></small> </td>
...
?>          </td>
          <td  height="100%" class="sidebarlt" ><?php $my_link=$scriptresponder."?which=".$rstempx[$IDfield]; ?>
             <div align="left"><small><a href="<?php echo $my_link; ?> ">  
               <?php echo $form_subject; ?>  
             </a></small></div></td>
          <td  height="100%" class="sidebarlt" ><small><?php echo $form_name; ?> </small> </td>
          <td  height="100%" class="sidebarlt" ><small><?php echo $form_indate; ?></small></td>
  <td height="100%" class="sidebarlt" ><form method="post" action="admin/assign.php?back=1">
              <small>
              <input type="hidden" name="problemid" value="<?php echo $problemid; ?>" />
              <input type="hidden" name="Tech" value="<?php echo $rstemp3["techid"]; ?>" />
              </small>
              <input type="submit" value="Assign" name="B1" /> </form>		 </td>
         </tr>
...
<?php }
	 ...
	 if ($count==0) 
	 { ?>  <p align="center" class="titlosGrante"><span class="error">You are not allowed to see this page.......</span>
           <meta http-equiv="Refresh" content="3;URL=techtesting.php" />
  <?php }?>
