...
<table border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#00FFFF">
  <tr class="sidebardk_noborder_v2">
    ...
    <!-- InstanceBeginEditable name="EditRegion1" --><br />
      <br />
<meta http-equiv="Refresh" content="1;URL=../../admin/edittech.php"/>
<?php 
...
$insertSQL = sprintf("INSERT INTO technicians (techemail,techname, techPhone,   techlogin) VALUES ('".$techemail."','".$techname."','".$techPhone."','".$techlogin."' )",
                       GetSQLValueString($_POST['rqd_moduletype_name'], "text"));
//echo $insertSQL;
 mysql_select_db($database_helpdesk, $helpdeskphp);
  $Result1 = mysql_query($insertSQL, $helpdeskphp) or die(mysql_error());
...
<!--webbot
bot="DatabaseRegionStart" i-checksum="65285" endspan -->
<!--webbot
bot="DatabaseRegionEnd" startspan b-tableformat="FALSE"
local_preview="&lt;TABLE width=&quot;100%&quot; align=&quot;center&quot; bgcolor=&quot;#FFFF00&quot;&gt;&lt;td&gt;&lt;p align=&quot;Center&quot;&gt;&lt;font color=&quot;#000000&quot;&gt;End of Database Region.&lt;/font&gt;&lt;/td&gt;&lt;/tr&gt;&lt;/table&gt;"
preview="&lt;p&gt;&lt;b&gt;Database: End&lt;/b&gt;&lt;/p&gt;" clientside tag="BODY" -->
<!--webbot
bot="DatabaseRegionEnd" i-checksum="55813" endspan -->


<p class="error"><strong><big>Your request has been set successfully!!!</big></strong></p>

<p><a href="../../admin/edittech.php">If not redirected , Click here to go back</a></p>
