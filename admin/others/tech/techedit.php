...
<?php $techid=$_POST["menu1"];
 if (!$_SESSION['valid_admin'])
    {header("Location: ../../../login.php"); }
    else
        {

$mySQL="select * from technicians ";
$mySQL=$mySQL."where techid="."'".$techid."' limit 1";
...
$rstemp=mysql_fetch_array($rstemp_query);
 ...
 // Now lets grab all the records
  ...
  $phone=$rstemp["techPhone"];
  $email=$rstemp["techemail"];
  $techid=$rstemp["techid"];
  $passwd=$rstemp["passwd"];
  $techlogin=$rstemp["techlogin"];
?>

<br />

<p align="center"><big><big><font color="#800000"><big><strong>VIEW technichian data</strong></big></font></big></big></p>
<p><strong><font color="#800000">Login :</font></strong><?php echo $techlogin; ?> </p>

<p><strong><font color="#800000">Name,Surname:</font></strong> <?php echo $techname; ?> </p>

<p><strong><font color="#800000">Bussiness Phone:</font></strong> <?php echo $phone; ?> </p>

<p><font color="#800000"><strong>Email Address:</strong></font> <?php echo $email; ?> <?php $rstemp=mysql_fetch_array($rstemp_query);
...
<p align="center"><big><big><font color="#800000"><big><strong>EDIT technichian data</strong></big></font></big></big></p>

<form action="update.php" method="post"  name="FrontPage_Form1" id="FrontPage_Form1">
  <input type="hidden" name="techid" value="<?php echo $techid; ?>" />
  <p><strong><font color="#800000">Login
  : </font></strong>
  <input name="techlogin" type="text" id="techlogin" value="<?php echo $techlogin; ?>" size="22" />
  </p>
  <p><strong><font color="#800000">Name,Surname :</font></strong>&nbsp;&nbsp;&nbsp; <input type="text" name="name" size="22" value="<?php echo $techname; ?>" /> 
  </p>
  <p><strong><font color="#800000">Bussiness Phone :</font></strong>&nbsp; <input type="text" name="phone" size="22" value="<?php echo $phone; ?>" />
    <br />
    <br />
    <strong><font color="#800000">E-mail :</font></strong>&nbsp;
    <input name="email" type="text" id="email" value="<?php echo $email; ?>" size="22" />
    <span class="error">*Must be <span class="style15 style21 style20 style16" style="color: #6600FF"><em>login</em></span>@cs.ucy.ac.cy </span> </p>
  <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input type="submit" value="Change" name="B1" />&nbsp;&nbsp;&nbsp; </p>
</form>

<p>&nbsp;</p>


<title>Trellian - a free Dreamweaver template from JustDreamweaver.com</title>
<meta name="Keywords" content="" />
<meta name="Description" content="" />
