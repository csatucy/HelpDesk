...
<table border="1" align="center" cellpadding="2" cellspacing="2" bordercolor="#00FFFF">
  <tr class="sidebardk_noborder_v2">
    ...
    <!-- InstanceBeginEditable name="EditRegion1" --><br />
      <br />
<?php $techname=$_POST["name"];
$techemail=$_POST["email"];
$techphone=$_POST["phone"];
$techid=$_POST["techid"];
$techlogin=$_POST["techlogin"];

$mySQL="UPDATE technicians SET techname='".$techname. "', techPhone='".$techphone."',  techlogin='".$techlogin."', techemail='".$techemail."'";
$mySQL=$mySQL."  WHERE techid=".$techid;
mysql_query($mySQL);

?>

<p><big><font color="#000000"><big><?php echo $techname; ?></big> </font><font color="#800080">data has been
successfully updated.!!! </font></big></p>

<p><a href="../../admin/edittech.php">If not redirected , Click here to go back</a> </p>  
<?php echo "<META HTTP-EQUIV='refresh' content='0;URL=../../admin/edittech.php'>"; ?>
