...
<?php $query_Allid="select * from technicians ";
$query_Allid=$query_Allid." ORDER BY technicians.techid"; //Epilegei olous tous technikous pou doulevoun akoma Working=1
$Allid = mysql_query($query_Allid, $helpdeskphp) or die(mysql_error()); //Me vasi to id tous
$row_Allid = mysql_fetch_assoc($Allid);
$totalRows_Allid = mysql_num_rows($Allid); 
...
$mySQLx="select * from problems ";
$mySQLx=$mySQLx."where assigned=1 AND solvedstate=0 ";
$rstempx_query=mysql_query($mySQLx);  
error();
$rstempx=mysql_fetch_array($rstempx_query);
?>
...
<p align="center"><span class="textintence style14"><font face="Arial">Unassigned Problems</font><b></b></span><b>
...
<table width="100%" border="0">
  <tr class="sidebardk" >
    <td width="5%"> No</td>
    <td width="6%" height="100%">State</td>
    <td width="29%" height="100%" >Topic</td>
    <td width="11%" height="100%" >Originator</td>
    <td width="5%" height="100%" >Date</td>
    <td width="9%" height="100%" >Replies From</td>
    <td width="8%" height="100%" >Assign To:</td>
    <td width="27%" height="100%" >Assign to Tech</td>
  <td></span></td>
  </tr>
...
$sqltemp="SELECT *";
$sqltemp=$sqltemp." FROM assigned ";
$sqltemp=$sqltemp." WHERE assigned.problemid=".$problemid;
$sqltemp=$sqltemp."  ORDER BY assignedid DESC";
...
?>
  <?php if ($count==0)
    ...
    {
?>
  <tr align="center" valign="middle" bgcolor="#FFFFCC" class="text">
    <td height="100%" class="sidebarlt"><small>
        <?php echo $problemid; ?>    </td>
    <td height="100%" class="sidebarlt">        <?php $flag2=0;
      $statement=0;
while(!($rsstate==0))
      {
        if ($flag2==0)
...
?>    </td>
    <td height="100%" class="sidebarlt">
      <?php $my_link=$scriptresponder."?which=".$rstempx[$IDfield]; ?>
     
        <div align="left"><small><a href="<?php echo $my_link; ?>">
          <?php echo $form_subject; ?>
        </a></small></div>
    </td><td height="100%" class="sidebarlt"><div align="left"><small>  <?php echo $form_name; ?>   </small> </div></td>
    <td height="100%" class="sidebarlt"><small>  <?php echo $form_indate; ?>  </small></td>
    <td height="100%" class="sidebarlt"><small>  <?php $flag=0;
while(!($rsReplies==0))
      {
        $flag=1;
...
?>
    ...
    <td class="sidebarlt" ><small><?php echo $rstemp['techname']?></small></td>
    <td height="100%" class="sidebarlt"><form method="post" action="assign.php">
          <small>
...
<p align="center"><b><strong><span style="color: #cc0000">All the problems reported , are assigned</span><font color="#800080">        
  <?php } ?>
</font></strong></b></p>
