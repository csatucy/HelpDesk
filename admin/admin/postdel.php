...
$query_Allid = "SELECT * FROM problems ORDER BY problems.problemid";
...
$totalRows_Allid = mysql_num_rows($Allid); ?>
    ...
    <span class="titlos"><br />
Remove a Problem</span><br />
<br />
<form action="removep.php" method="post"  name="FrontPage_Form1" id="FrontPage_Form1">
  <div align="left">
    <p><strong>Problems that have been reported this month and the previous one :</strong></p>
    <p>&nbsp;
      <select name="menu_problem" class="fieldbg" id="SelectConsumable">
        <option value="0" selected="selected">-- Problem Number, Subject --</option>
        <?php
do {  
?>
        <option value="<?php echo $row_Allid['problemid']?>"><?php echo $row_Allid['problemid'].", ".$row_Allid['subject'].",".$row_Allid['name'].",".$row_Allid['indate'];?></option>
        <?php
...
?>
      ...
      <input name="problemid" type="hidden" id="problemid" value="<?php echo $menu_problem; ?>" /> 
        </p>
    <dd>&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="submit" value="Remove the Problem" name="B1" />
        <input
    type="reset" value="Reset All" />
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; </dd>
  </div>
</form>
</center></div><?php $techlogin="techlogin";
$passwd="passwd";
if (strlen($techlogin)>0 && strlen($passwd)>0)
{
...
<p align="center" class="error"><strong>Please ensure first that at least one
problem exist !!!</strong></p>
<?php }
    else
  {
?>
