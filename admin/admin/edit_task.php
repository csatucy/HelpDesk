...
<form action="update_task.php" method="post" name="FrontPage_Form3" id="FrontPage_Form3" onsubmit="return FrontPage_Form3_Validator(this)">
  ...
  <tr class="tasks_sidebar">
    <td width="593" align="center" height="21">
        <span class="text_header"><?php echo _("Edit your task"); ?>
